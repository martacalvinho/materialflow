/*
  # Initial Schema Setup for Treqy

  1. New Tables
    - users: Core user accounts with role management
    - clients: Client organizations linked to users
    - projects: Material specification projects
    - materials: Material definitions
    - material_instances: Material usage in specific projects
    - manufacturers: Material suppliers/manufacturers
  ...
  3. Changes
    ...
    - Added foreign key constraints with appropriate deletion behavior
*/
