  ...
  return (
    <footer className="bg-surface-900 text-white py-12 md:py-16 px-4 md:px-6">
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-2">
              <Logo />
              <span className="font-semibold text-xl">Treqy</span>
            </Link>
            <p className="mt-4 text-surface-400">
              Know what you spec. Organize your material universe.
            </p>
          </div>
        ...
        <div className="mt-12 md:mt-16 pt-8 border-t border-surface-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-surface-400 text-sm text-center md:text-left">
            © {new Date().getFullYear()} Treqy. All rights reserved.
          </p>
